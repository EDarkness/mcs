...
namespace MCS.EDITORS
{
	...
	{
		protected MCSCharacterManager charMan = null;
...
//							Debug.Log("FDFG");
        ...
        protected void EditorMorphs(List<MCS.FOUNDATIONS.Morph> morphs, List<MCS.FOUNDATIONS.Morph> dirtyMorphValues, List<MCS.FOUNDATIONS.Morph> dirtyMorphAttachments,
        ...
        protected bool DisplayClothingMesh(MCS.COSTUMING.CIclothing mesh)
		{
			bool result;
			EditorGUILayout.BeginHorizontal();
...
//				lockItem = mesh.isLocked;
		...
		protected bool DisplayProp(MCS.COSTUMING.CIprop prop)
		{
			bool result;
			EditorGUILayout.BeginHorizontal();
		...
		#region hair_display
		protected bool DisplayHair(MCS.COSTUMING.CIhair mesh)
		{
			bool result;
			EditorGUILayout.BeginHorizontal();
            string labelStr = String.IsNullOrEmpty(mesh.name) ? mesh.ID : mesh.name;
